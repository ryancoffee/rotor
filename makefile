...
_SRCS=Molecules.cpp Propagators.cpp PulseFreq.cpp PulseTime.cpp ScanParams.cpp jEnsemble.cpp vEnsemble.cpp rotormain.cpp
_HEADS=Constants.hpp DataOps.hpp Molecules.hpp Propagators.hpp PulseFreq.hpp PulseTime.hpp ScanParams.hpp jEnsemble.hpp vEnsemble.hpp rotormain.hpp
